...
private var HTMLElement.__rock__hiddenAnim by JsAnyDelegate<HTMLElement, Animation>("__rock__hiddenAnim")
private var HTMLElement.__rock__hiddenAnim2 by JsAnyDelegate<HTMLElement, Animation>("__rock__hiddenAnim2")
private var HTMLElement.__rock__goalHidden by JsAnyDelegate<HTMLElement, JsBoolean>("__rock__goalHidden")
        ...
        window.setTimeout({
            calculationContext.reactiveScope {
                ...
                if (animationsEnabled) {
                    ...
                    (this.js.__rock__hiddenAnim as? Animation)?.let {
                        oldAnimTime = it.currentTime
                        it.cancel()
                    }
                    (this.js.__rock__hiddenAnim2 as? Animation)?.let {
                        it.cancel()
                    }
                    this.js.__rock__goalHidden = value.toJsBoolean()
                    js.hidden = false
...
//                        full.transformOrigin = "top left"
                    ...
                    this.animate(
                        ...
                        it.onfinish = { ev ->
                            if (this.__rock__hiddenAnim == it) {
                                hidden = value
                                classList.remove("animatingShowHide")
                                this.__rock__hiddenAnim = null
