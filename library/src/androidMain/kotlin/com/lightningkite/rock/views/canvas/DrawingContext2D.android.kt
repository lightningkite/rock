...
import com.lightningkite.rock.views.Path.DrawingResources
...
actual var DrawingContext2D.strokePaint: com.lightningkite.rock.models.Paint
    get() = Color.fromInt(fillPaintObj.color)
    set(value) {
        strokePaintObj.color = value.colorInt()
    }
actual var DrawingContext2D.fillPaint: com.lightningkite.rock.models.Paint
    get() = Color.fromInt(fillPaintObj.color)
    set(value) {
