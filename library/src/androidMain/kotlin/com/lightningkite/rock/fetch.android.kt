...
actual class Blob(val data: Uri) {
    fun getContentType(): ContentType {
        val cr = AndroidAppContext.applicationCtx.contentResolver
        return ContentType.parse(cr.getType(data) ?: "application/octet-stream")
    }
}
